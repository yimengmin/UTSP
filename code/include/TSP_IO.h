...
#define Max_Inst_Num       128 //!!! The number of test instances
#define Max_City_Num       200 //!!! The number of cities
...
int Total_Instance_Num = 128; //!!! The number of test instances
...
int Inst_Num_Per_Batch=int(Total_Instance_Num / 32); //!!! The number of threads, should match what you put in solve.sh
 ...
 */
int Rec_Num = 200; //!!! The number of cities
